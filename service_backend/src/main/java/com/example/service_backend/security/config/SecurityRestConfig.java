package com.example.service_backend.security.config;
...
import com.example.service_backend.security.auth.AuthEntryPoint;
import com.example.service_backend.security.auth.AuthRequestFilter;
...
public class SecurityRestConfig extends WebSecurityConfigurerAdapter {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:3001", "http://159.65.60.64:3001", "http://20.77.90.223:3001"));
